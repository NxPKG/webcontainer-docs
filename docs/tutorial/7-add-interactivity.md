...
And - that's it! You have a fully working terminal 🥳 To see the end product, check [this demo](https://nxpkg.khulnasoft.com/edit/nxpkg-webcontainer-api-starter-with-terminal?file=main.js).
