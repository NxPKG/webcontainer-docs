...
You can follow along this tutorial using our [Vite starter](https://nxpkg.khulnasoft.com/edit/vitejs-vite-jkerkn?file=index.html&terminal=dev) which you can later share with friends, colleagues, or on social media:

[![Open in NxPKG](https://dev-nxpkg.khulnasoft.com/img/open_in_nxpkg.svg)](https://vite.new)
...
If you're using the NxPKG editor, you can skip this step.
...
![A browser window with empty page and a tab featuring the title "My first WebContainers app" and NxPKG logo](./images/2-no-welcome-screen.png)
