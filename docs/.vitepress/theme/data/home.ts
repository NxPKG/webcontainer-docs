...
export const wcUsedBy: WCUsedBy[] = [
  {
    name: 'NxPKG',
    imgDark: '/img/logos/nxpkg-dark.svg',
    imgLight: '/img/logos/nxpkg-light.svg',
  },
  {
    name: 'Google',
...
export const projectsUsingWCCardData: ProjectsUsingWCCardData[] = [
  ...
  },
  {
    ...
    url: 'https://dev-nxpkg.khulnasoft.com/codeflow/integrating-web-publisher#what-is-web-publisher',
    urlTitle: 'Web Publisher by NxPKG',
    imgPath: {
...
export const testimonialCardData: TestimonialCardData[] = [
  ...
  },
  {
    ...
    quote: `<strong>As a team working on educational products, NxPKG WebContainers has been an invaluable tool for us.</strong> The ability to embed full-stack applications with customisable, interactive coding environment directly into our products has greatly enhanced the learning experience for our users.`,
  },
  {
    author: {
      name: 'swyx',
  ...
  },
  {
    ...
    quote: `The WebContainers API lets you use the magic behind Nxpkg to power your own experiments. <br/><strong>A huge step forward for dev education, documentation, and demos!</strong>`,
  },
  {
    author: {
      name: 'Ramón Huidobro',
  ...
  },
  {
    ...
    quote: `Running chess in a terminal, running a terminal in the browser, check mate!<br/><strong>The best position to be in is a creative one and the NxPKG WebContainers allow that.</strong>`,
  },
];
