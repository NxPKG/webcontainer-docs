...
export default defineConfig({
  ...
  themeConfig: {
    ...
    editLink: {
      pattern: 'https://pr.new/nxpkg/webcontainer-docs/edit/main/docs/:path',
      text: 'Edit this page',
    },
    algolia: getAlgoliaConfig(process.env),
    socialLinks: [
      { icon: 'github', link: 'https://github.com/nxpkg/' },
      { icon: 'twitter', link: 'https://twitter.com/nxpkg' },
      { icon: 'discord', link: 'https://discord.gg/nxpkg' }
    ]
  },
...
function getHeadTags(env: NodeJS.ProcessEnv): HeadConfig[] {
  const tags: HeadConfig[] = [
    ...
    ['meta', { name: 'twitter:site', content: '@NxPKG' }],
  ];
